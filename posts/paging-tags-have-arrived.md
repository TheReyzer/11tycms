...
id: 15
thumbnail: /images/uploads/paging-tags-have-arrived.jpg
title: Paging tags have arrived!
description: I finally did it, thanks Zach and the community for support.
categories:
  - Dev
date: 2022-09-14T17:45:00.294Z
---
Let's start...
...
Now I have two problems and I will try to be clear.

**In the first problem, I need to show the posts in reverse order like this:**
...
When I enter in `/tags/Dev/` the prev button href need to be disabled because the page is `1` but the href sends me to another tag page like `/tags/posts/`.
I just need the pagination inside the tag and not between the tags.